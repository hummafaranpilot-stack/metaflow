...
function addOrderLinks () {
  ...
  for(i=0; i<bottles6.length; i++) {
    ...
    bottles6[i].onclick = function() {
      ...
      if(window.redirectM || window.redirectD ) {
        window.location = orderLink+'&redirect='+btoa('https://'+window.location.hostname+'/6/') +"&"+window.variables+"&sessid2="+getCookieValue('sessid2');
      }else {
  ...
  for(i=0; i<bottles3.length; i++) {
    bottles3[i].onclick = function() {
      ...
      if(window.redirectM || window.redirectD ) {
        window.location = orderLink+'&redirect='+btoa('https://'+window.location.hostname+'/3/') +"&"+window.variables+"&sessid2="+getCookieValue('sessid2');
      }else {
        window.location = orderLink+"&"+window.variables;
      }
  ...
  for(i=0; i<bottles1.length; i++) {
    bottles1[i].onclick = function() {
      ...
      if(window.redirectM || window.redirectD ) {
        window.location = orderLink+'&redirect='+btoa('https://'+window.location.hostname+'/1/') +"&"+window.variables+"&sessid2="+getCookieValue('sessid2');
      }else {
        window.location = orderLink+"&"+window.variables;
      }
